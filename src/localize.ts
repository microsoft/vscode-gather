...
export namespace Common {
    export const gatherError = localize('Gather.gatherError', 'Gather internal error');
    ...
    export const gatheredScriptDescription = localize(
        'Gather.gatheredScriptDescription',
